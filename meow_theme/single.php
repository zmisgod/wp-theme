<?php get_header(); ?>
    <script type="text/babel" src="/js/react/comments/comments.js"></script>
<?php if (have_posts()) :
    the_post();
            ...
            <div class="col-md-9">
                <div class="col-md-9 col-md-offset-3 m-content-main clearfix">
                    <div class="m-header-guide">
                        <p><span><a href="<?php $PHP_SELF = $_SERVER['PHP_SELF'];
                                $url = 'http://' . $_SERVER['HTTP_HOST'] . substr($PHP_SELF, 0, strrpos($PHP_SELF, '/') + 1);
                                echo $url; ?>">首页</a></span> >
                            <span><?php the_category(', ') ?> > </span><span><?php the_title(); ?></span></p>
                    </div>
                    <div class="content-header">
                        ...
                        <div class="pull-left">
                            ...
                            <p class="content-other-info"><span>by <?php the_author_posts_link(); ?></span> /
                                <span><?php the_time('Y年n月j日'); ?></span></p>
                        </div>
                    </div>
